...
user_route.post("/create-transaction", ensureAuthenticated, async (req, res) => {
  try {
      const {
          transiction,
          customer_id,
...
user_route.get("/single-user-transactions/:id",ensureAuthenticated,async(req,res)=>{
    try {
...
user_route.post("/payout",ensureAuthenticated,async (req, res) => {
    try {
...
user_route.get("/withdrawal/:userId",ensureAuthenticated,async (req, res) => {
    try {
